...
const CommanderDashboard = ({ onLogout }: CommanderDashboardProps) => {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="w-80 bg-background border-r flex-shrink-0">
            <div className="p-4 border-b">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setSidebarOpen(false)} className="p-2 hover:bg-muted rounded-lg transition-colors">✕</button>
              </div>
            </div>
        ...
        <div className="flex-1">
          <div className="max-w-md mx-auto">
            ...
            <div className="top-bar">
              <button onClick={() => setSidebarOpen(true)} className="hover:bg-white/10 p-1 rounded transition-colors">
                <Menu className="w-5 h-5" />
              </button>
              <h1 className="font-semibold">Challenge Commander</h1>
              <button onClick={onLogout} className="hover:bg-white/10 p-1 rounded transition-colors flex items-center gap-1">
      ...
      <button onClick={scrollToTop} className="floating-rocket">
